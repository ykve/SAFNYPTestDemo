                           ...
                           progressBlock:(BADownloadProgressBlock)progressBlock
{
    ...
    if(!([URLString containsString:@"register"] || [URLString containsString:@"findPassword"] || [URLString containsString:@"findPassword"] || [URLString containsString:@"loginByMobile"] || [URLString containsString:@"app/banner/login"] || [URLString containsString:@"touristLogin"] || [URLString containsString:@"captcha"] || [URLString containsString:@"sendCode"])) {
