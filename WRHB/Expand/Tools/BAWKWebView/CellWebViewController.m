...
@interface CellWebViewController ()
...
@implementation CellWebViewController
...
- (void)viewDidLayoutSubviews {
    ...
    CGFloat widht = 30;
    self.view.frame = CGRectMake(widht, 0, kSCREEN_WIDTH - widht*2, kTopupWebCellHeight-10);
//    self.view.backgroundColor = [UIColor redColor];
    self.webView.frame = CGRectMake(0, 0, kSCREEN_WIDTH - widht*2, kTopupWebCellHeight-10);
    self.progressView.frame = CGRectMake(0, 0, BAKit_SCREEN_WIDTH -widht*2, 20);
}
