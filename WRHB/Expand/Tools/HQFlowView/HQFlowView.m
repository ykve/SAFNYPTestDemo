...
- (void)initialize {
    ...
    self.scrollView.decelerationRate = 0.12;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(hqScrollViewDidScroll:)]) {
        CGFloat offsetRatio = scrollView.contentOffset.x/CGRectGetWidth(scrollView.frame) - 1 -6;
        [_delegate hqScrollViewDidScroll:offsetRatio];
    }
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(willStartScrolling:)]) {
        [_delegate willStartScrolling:scrollView];
    }
