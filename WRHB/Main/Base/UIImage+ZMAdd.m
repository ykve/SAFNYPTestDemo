...
+ (UIImage *)zm_decodingBase64ToImageWithString:(NSString *)_imageString{
    if (_imageString.length>0) {
        NSString *str = [_imageString stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        str = [str stringByReplacingOccurrencesOfString:@"\r" withString:@""];
        str = [str stringByReplacingOccurrencesOfString:@"\n" withString:@""];
        str = [[str stringByReplacingOccurrencesOfString:@"data:image/png;base64," withString:@""] stringByReplacingOccurrencesOfString:@"data:image/jpeg;base64," withString:@""];
