...
@interface ClubGameTypeController ()<SPPageMenuDelegate, UIScrollViewDelegate,SDCycleScrollViewDelegate>
...
@implementation ClubGameTypeController
...
- (void)topViewAddController {
    ...
    controllerClassNames = [NSArray arrayWithObjects:@"ClubRedPacketItemController",@"ClubDianZiItemController",@"ClubQiPaiItemController",@"ClubCasualItemController", nil];
