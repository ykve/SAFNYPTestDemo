...
@interface LMTwoBaseGameItemController () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,UICollectionViewDelegate>
...
@implementation LMTwoBaseGameItemController
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([model.items[indexPath.row] isKindOfClass:[ChatsModel class]]) {
        ...
        cell.scorllTextLable.text = cmodel.desc;
    }
...
- (void)groupChat:(ChatsModel *)model gamesTypeModel:(GamesTypeModel *)gamesTypeModel {
    ...
    [self routerEventWithName:@"LMTwoBaseGameItemControllerGoToChat" user_info:dict];
}
