...
@interface TwoBaseGameItemController () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,UICollectionViewDelegate>
...
@implementation TwoBaseGameItemController
