...
- (void)setLayout {
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[_bottomLine]|"
                                                                             ...
                                                                             metrics:nil
                                                                               views:self.cellSubViews]];
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_bottomLine(0.7)]|"
                                                                             options:0
                                                                             metrics:nil
                                                                               views:self.cellSubViews]];
...
- (void)setCellStyle:(RCDBaseSettingCellStyle)style {
    ...
    case SwitchStyle: {
        ...
        constraints = @"H:|-10-[_leftLabel]-(>=10)-[_switchButton]-15-|";
    } break;
    default:
        break;
    }
