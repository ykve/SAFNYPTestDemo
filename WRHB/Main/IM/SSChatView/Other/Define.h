...
//当前窗口的高度 宽度
#define YPSCREEN_Height [[UIScreen mainScreen] bounds].size.height
#define YPSCREEN_Width  [[UIScreen mainScreen] bounds].size.width


#define makeColorRgb(_r, _g, _b)   [UIColor colorWithRed:_r / 255.0f green: _g / 255.0f blue:_b / 255.0f alpha:1]

#define YPChatCellColor  makeColorRgb(250, 250, 250)
