...
//表情的行数 列数
#define YPChatEmojiRow     3
#define YPChatEmojiLine    7
...
/**
 表情模型
 */
@interface YPChatIMEmotionModel : NSObject
...
/**
 表单Layout
 */
@interface YPChatCollectionViewFlowLayout : UICollectionViewFlowLayout
