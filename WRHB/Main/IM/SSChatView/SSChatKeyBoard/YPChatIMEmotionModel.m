//
//  YPChatIMEmotionModel.m
//  htcm
//
//  Created by soldoros on 2019/10/1.
...
@implementation YPChatIMEmotionModel

+ (YPChatIMEmotionModel *)modelWithDictionary:(NSDictionary*)dic atIndex:(int)index{
    
    YPChatIMEmotionModel* model = [YPChatIMEmotionModel new];
...
- (void)initEmotionImages{
    ...
    YPChatIMEmotionModel* model = nil;
    NSDictionary* dic = nil;
    for (int i = 0; i < array.count; i++) {
        dic = array[i];
        model = [YPChatIMEmotionModel modelWithDictionary:dic atIndex:i];
...
-(NSMutableArray *)dealWithArray:(NSMutableArray *)arr1 arr2:(NSMutableArray *)arr2{
    ...
    NSInteger k = 1;
    NSInteger number = YPChatEmojiRow * YPChatEmojiLine;
...
//表单Layout
@implementation YPChatCollectionViewFlowLayout

- (void)prepareLayout {
    [super prepareLayout];
    
    CGFloat W = (self.collectionView.bounds.size.width) / YPChatEmojiLine;
    CGFloat H = (self.collectionView.bounds.size.height) / YPChatEmojiRow;
    ...
    CGFloat Y = (self.collectionView.bounds.size.height - YPChatEmojiRow * H);
