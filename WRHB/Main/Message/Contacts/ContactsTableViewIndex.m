...
@interface ContactsTableViewIndex (){
    BOOL isLayedOut;
...
@implementation ContactsTableViewIndex
...
- (void)setTableViewIndexDelegate:(id<ContactsTableViewIndexDelegate>)tableViewIndexDelegate
{
