...
@interface YPMenuView()
@property (strong, readwrite, nonatomic) YPMenu *menu;

@property (nonatomic, assign) IFMMenuViewArrowDirection arrowDirection;
@property (nonatomic, strong) NSArray *menuItems;
@property (nonatomic, assign) CGFloat arrowPosition;
@property (nonatomic, strong) UIView *contentView;
@end

@implementation YPMenuView
             ...
             menuItems:(NSArray *)menuItems
{
    ...
    YPMenuContainerView *overlay = [[YPMenuContainerView alloc] initWithFrame:view.bounds];
...
-(void)dismiss:(NSNumber *)animate{
    [self dismissMenu:[animate boolValue]];
}
...
- (void)menuItemClick:(UIButton *)sender
{
    ...
    YPMenuItem *menuItem = _menuItems[button.tag];
...
- (UIView *)makeContentView{
    ...
    //获得最大item的宽度和高度
    for (YPMenuItem *menuItem in _menuItems) {
    ...
    //加上各种间距
    maxItemWidth = maxItemWidth +_menu.edgeInsets.left+_menu.edgeInsets.right+_menu.gapBetweenImageTitle + 10;
